...
<body>
  ...
  <div class="form-container">
      ...
      <form class="form" id="form-register-extensiones" action="" method="post" enctype="multipart/form-data">
          @csrf
          
          <!-- Campo para el nombre de la extensión -->
          <div class="input-group">
            <label for="nombre_extension">Nombre de la Extensión</label>
            <input type="text" name="nombre_extension" id="nombre_extension" placeholder="Ingresa el nombre de la extensión" required>
          </div>
          
          <!-- Campo para la imagen de la extensión -->
          <div class="input-group">
            <label for="imagen_extension">Imagen de la Extensión</label>
            <input type="file" name="imagen_extension" id="imagen_extension" required>
          </div>

          <!-- Campo para la cantidad de extensiones -->
          <div class="input-group">
            <label for="cantidad_extension">Cantidad de Extensiones</label>
            <input type="number" name="cantidad_extension" id="cantidad_extension" placeholder="Ingresa la cantidad de extensiones" min="1" required>
          </div>
